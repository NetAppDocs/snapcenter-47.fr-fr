...
Volet activité
 a| 
.. Après avoir lancé l'opération de sauvegarde, cliquez sur * *image:../media/activity_pane_icon.gif["icône d'activité"]dans le volet activité pour afficher les cinq opérations les plus récentes.
