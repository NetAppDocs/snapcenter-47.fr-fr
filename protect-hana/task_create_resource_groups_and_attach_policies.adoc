...
.. Dans la colonne configurer les plannings, cliquez sur * *image:../media/add_policy_from_resourcegroup.gif["ajouter une stratégie à partir d'un groupe de ressources"]pour la stratégie que vous souhaitez configurer.
